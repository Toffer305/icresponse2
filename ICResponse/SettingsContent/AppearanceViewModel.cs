...
namespace ICResponse.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        private bool _colorLoadedYet = false;
        ...
        public AppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "icrealtime", Source = new Uri("pack://application:,,,/ICResponse;component/Assets/ModernUI.ICRTheme.xaml") });
        ...
        private void SyncThemeAndColor()
        {
            ...
            {
                ICResponse.Properties.Settings.Default.SelectedThemeDisplayName = this.SelectedTheme.DisplayName;
                ICResponse.Properties.Settings.Default.SelectedThemeSource = this.SelectedTheme.Source;
                ICResponse.Properties.Settings.Default.SelectedAccentColor = this.SelectedAccentColor;
                ICResponse.Properties.Settings.Default.SelectedFontSize = this.SelectedFontSize;
